...
all: classes
	javac -d classes -cp $(CLASSES) ./FONTS/G45/*.java ./FONTS/CLUSTER/DOMINIO/CLASES/*.java ./FONTS/CLUSTER/PERSISTENCIA/*.java ./FONTS/CLUSTER/DOMINIO/CONTROLADORES/*.java ./FONTS/CLUSTER/DOMINIO/CONTROLADORES/DRIVERS/*.java
